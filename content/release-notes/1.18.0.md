...
* Added new template functions for [`TLSCACert`](/reference/template-functions/static-context/#tlscacert), [`TLSCertFromCA`](/reference/template-functions/static-context/#tlscertfromca), and [`TLSKeyFromCA`](/reference/template-functions/static-context/#tlskeyfromca)
...
* [`Other S3-Compatible Storage`](/kotsadm/snapshots/storage-destinations/#s3-compatible) in snapshot settings now works.
